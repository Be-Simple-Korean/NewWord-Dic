    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.reg_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!email.contains("@")){
                    Toast.makeText(Register.this, "이메일을 정확히 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(pwd.length()<6){
                    Toast.makeText(Register.this, "비밀번호는 6자리 이상으로 입력해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(nick.equals("")){
                ...
                if(tar.size()>0){
                    for(int i =0;i<tar.size();i++){
                        if(tar.get(i).equals(nick)){
                            Toast.makeText(Register.this, "중복된 닉네임입니다. 수정해주세요", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        if(i+1==tar.size()){
                ...
                .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Register.this, "회원가입 실패",
